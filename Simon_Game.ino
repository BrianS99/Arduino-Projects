 ...
 *  Date: July 20, 2020
 *  This is the Simon Game, played with coloured LEDs and buttons. 
 */

#include <time.h>
#include <NewPing.h>

//defining all input/output pins
#define green 2
#define red 3
#define yellow 4
#define blue 5
...
//generates random number sequence to determine game
...
//plays a beep noise from buzzer
void playSound(void){
